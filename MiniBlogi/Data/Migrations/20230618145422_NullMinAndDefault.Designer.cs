...
namespace MiniBlogi.Data.Migrations
{
    ...
    [Migration("20230618145422_NullMinAndDefault")]
    partial class NullMinAndDefault
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MiniBlogi.Models.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlogPostTag", b =>
                {
                    ...
                    b.HasOne("MiniBlogi.Models.Tag", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MiniBlogi.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MiniBlogi.Models.BlogPost", b =>
                {
                    b.HasOne("MiniBlogi.Models.ApplicationUser", "User")
                        .WithMany("Posts")
                        .HasForeignKey("UserId");
